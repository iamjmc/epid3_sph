...
tbl_merge(list(fit.strata.LHS, fit.strata.HS, fit.strata.SC, fit.strata.CG), tab_spanner  = c("Less than HS", "High School grad", "Some College", "College Grad"))
...
interactionR1 <- interactionR(fit.interaction,
exposure_names = c("college", "hasinsurance"),
ci.type = "delta", ci.level = 0.95,
em = F,  #T for EMM, F for interaction
recode = T
) 
interactionR_table(interactionR1, file_path = "interactionR2")

interactionR2 <- interactionR(fit.interaction,
exposure_names = c("college", "hasinsurance"),
ci.type = "delta", ci.level = 0.95,
em = T, 
recode = T
) 
  interactionR_table(interactionR2, file_path = "interactionR2")
